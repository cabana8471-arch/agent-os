...
> **Related Standards**: See `global/logging.md` for performance logging thresholds, `backend/queries.md` for query optimization, `frontend/responsive.md` for Core Web Vitals, `frontend/css.md` for CSS optimization.
...
- **Database Query Performance**: Monitor and optimize slow queries; batch operations when possible (see `backend/queries.md`)
